...
Func EditSettings($ProfilSel)
	...
	Global $Label33 = GUICtrlCreateLabel("Grab Timeout :", 16, 192, 74, 17)
	...
	Global $CheckboxUsePath = GUICtrlCreateCheckbox("UsePath", 552, 64, 97, 17)
	Global $CheckboxResActivated = GUICtrlCreateCheckbox("Res Activé", 552, 96, 97, 17)
	Global $InputResLife = GUICtrlCreateInput("", 608, 120, 33, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	Global $Label35 = GUICtrlCreateLabel("Nb res :", 552, 128, 41, 17)
	...
	Global $Label37 = GUICtrlCreateLabel("Proj (%vie) :", 400, 94, 59, 17)
	Global $Label38 = GUICtrlCreateLabel("Peste (% vie) :", 400, 123, 71, 17)
	...
	Global $Label39 = GUICtrlCreateLabel("Profa (% vie) :", 400, 152, 69, 17)
	Global $Label40 = GUICtrlCreateLabel("Glace (% vie) :", 400, 181, 72, 17)
	Global $Label41 = GUICtrlCreateLabel("Poison (% vie) :", 400, 210, 76, 17)
	Global $Label42 = GUICtrlCreateLabel("Explo (% vie) :", 401, 240, 70, 17)
	Global $Label43 = GUICtrlCreateLabel("Lave (% vie) :", 401, 270, 68, 17)
	Global $Label44 = GUICtrlCreateLabel("Mine (% vie) :", 401, 298, 67, 17)
	Global $Label45 = GUICtrlCreateLabel("Arm (% vie) :", 401, 327, 62, 17)
	Global $Label46 = GUICtrlCreateLabel("Spore (% vie) :", 401, 356, 72, 17)
