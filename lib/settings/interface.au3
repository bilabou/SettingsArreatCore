...
Func EditSettings($ProfilSel)
	...
	Global $Main = GUICreate("Edition de settings.ini et settingsHero.ini", 666, 432, -1, -1, -1, $WS_EX_TOPMOST)
	GUISetIcon(@scriptdir & "\lib\ico\icon.ico", -1)
	...
	Global $Label12 = GUICtrlCreateLabel("Temps de Pause :", 24, 130, 89, 17)
	...
	GUICtrlSetData(-1, "Act Aléatoire (Act1,Act2,Act3)|Séquence par défaut/Test/ect|Act 1|Act 2|Act 3|Act 3 quête 3 sous quête 3 --> Tuer Ghom|Act 3 quête 6 sous quête 2 --> Tuer le Briseur de Siège|Act 3 quête 7 sous quête 3 --> Terrasser Asmodan")
	Global $Label15 = GUICtrlCreateLabel("Changement acte :", 24, 266, 93, 17)
	...
	Global $Label8 = GUICtrlCreateLabel("PM :", 344, 152, 85, 17)
	...
	Global $Label20 = GUICtrlCreateLabel("SpecialmonterList :", 16, 360, 93, 17)
	Global $Label21 = GUICtrlCreateLabel("MonsterList :", 24, 336, 64, 17)
	Global $InputSpecialmonterList = GUICtrlCreateInput("", 112, 352, 529, 21)
	Global $InputMonsterList = GUICtrlCreateInput("", 112, 328, 529, 21)
	Global $Label22 = GUICtrlCreateLabel("Act1_Hero_Axe_Z :", 344, 216, 98, 17)
	Global $Label23 = GUICtrlCreateLabel("Act2_Hero_Axe_Z :", 344, 248, 98, 17)
	Global $Label24 = GUICtrlCreateLabel("Act3_Hero_Axe_Z :", 344, 280, 98, 17)
	...
	Global $Label25 = GUICtrlCreateLabel("Hero_Axe_Z :", 512, 248, 70, 17)
	Global $InputProfil = GUICtrlCreateInput("", 24, 40, 241, 21)
	...
	Global $Label4 = GUICtrlCreateLabel("Stock de potions :", 16, 96, 90, 17)
	Global $InputPotionStock = GUICtrlCreateInput("", 106, 88, 41, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	...
	Global $Label30 = GUICtrlCreateLabel("AttackRange :", 168, 160, 73, 17)
	Global $Label31 = GUICtrlCreateLabel("GrabRange :", 168, 192, 65, 17)
	Global $CheckboxMonsterTri = GUICtrlCreateCheckbox("MonsterTri", 16, 352, 97, 17)
	Global $CheckboxMonsterRefresh = GUICtrlCreateCheckbox("MonsterRefresh", 16, 320, 97, 17)
	Global $CheckboxItemRefresh = GUICtrlCreateCheckbox("ItemRefresh", 16, 224, 97, 17)
	Global $CheckboxMonsterPriority = GUICtrlCreateCheckbox("MonsterPriority", 16, 256, 97, 17)
	Global $CheckboxInventoryCheck = GUICtrlCreateCheckbox("InventoryCheck", 16, 288, 97, 17)
	...
	Global $CheckboxGestionaffixeloot = GUICtrlCreateCheckbox("Gestion_affixe_loot", 168, 288, 129, 17)
	Global $InputBanAffixList = GUICtrlCreateInput("", 240, 88, 137, 21)
	Global $Label32 = GUICtrlCreateLabel("Attacktimeout :", 16, 160, 75, 17)
	Global $Label33 = GUICtrlCreateLabel("Grabtimeout :", 16, 192, 67, 17)
	Global $Label34 = GUICtrlCreateLabel("BanAffixList :", 168, 96, 65, 17)
	...
	Global $CheckboxResActivated = GUICtrlCreateCheckbox("ResActivated", 536, 96, 97, 17)
	Global $InputResLife = GUICtrlCreateInput("", 592, 120, 33, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	Global $Label35 = GUICtrlCreateLabel("ResLife :", 536, 128, 46, 17)
	...
	Global $Label47 = GUICtrlCreateLabel("SequenceFileAct1 :", 18, 51, 97, 17)
	Global $InputSequenceAct1 = GUICtrlCreateInput("", 122, 43, 481, 21)
	Global $Label48 = GUICtrlCreateLabel("SequenceFileAct2 :", 18, 83, 97, 17)
	Global $InputSequenceAct2 = GUICtrlCreateInput("", 122, 75, 481, 21)
	Global $Label49 = GUICtrlCreateLabel("SequenceFileAct3PtSauve :", 20, 114, 138, 17)
	Global $InputSequenceAct3Pt = GUICtrlCreateInput("", 164, 106, 441, 21)
	Global $InputSequenceAct3 = GUICtrlCreateInput("", 124, 138, 481, 21)
	Global $Label50 = GUICtrlCreateLabel("SequenceFileAct3 :", 20, 146, 97, 17)
	Global $Label51 = GUICtrlCreateLabel("SequenceFileAct333 :", 17, 180, 109, 17)
	Global $Label52 = GUICtrlCreateLabel("SequenceFileAct362 :", 17, 212, 109, 17)
	Global $Label53 = GUICtrlCreateLabel("SequenceFileAct373 :", 17, 244, 109, 17)
	Global $InputSequenceAct333 = GUICtrlCreateInput("", 139, 172, 465, 21)
	Global $InputSequenceAct362 = GUICtrlCreateInput("", 139, 204, 465, 21)
	Global $InputSequenceAct373 = GUICtrlCreateInput("", 139, 236, 465, 21)
	...
	Global $CheckboxSpellOnLeft = GUICtrlCreateCheckbox("SpellOnLeft", 88, 120, 97, 17)
	Global $CheckboxSpellOnRight = GUICtrlCreateCheckbox("SpellOnRight", 88, 184, 97, 17)
	Global $Label86 = GUICtrlCreateLabel("SpellDelayLeft :", 192, 120, 78, 17)
	...
	Global $Label87 = GUICtrlCreateLabel("SpellTypeLeft :", 360, 120, 75, 17)
	Global $Label88 = GUICtrlCreateLabel("SpellEnergyNeedsLeft :", 88, 152, 115, 17)
	Global $InputSpellEnergyNeedsLeft = GUICtrlCreateInput("", 216, 144, 41, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	Global $Label89 = GUICtrlCreateLabel("SpellLifeLeft :", 280, 152, 68, 17)
	Global $InputSpellLifeLeft = GUICtrlCreateInput("", 360, 144, 41, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	Global $Label90 = GUICtrlCreateLabel("SpellDistanceLeft :", 424, 152, 93, 17)
	Global $InputSpellDistanceLeft = GUICtrlCreateInput("", 528, 144, 41, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	Global $Label91 = GUICtrlCreateLabel("SpellDelayRight :", 192, 184, 85, 17)
	Global $Label92 = GUICtrlCreateLabel("SpellTypeRight :", 360, 184, 82, 17)
	...
	Global $GroupTouche1 = GUICtrlCreateGroup("Touche 1", 64, 40, 537, 73)
	Global $CheckboxSpellOn1 = GUICtrlCreateCheckbox("SpellOn1", 72, 58, 73, 17)
	Global $Label54 = GUICtrlCreateLabel("SpellDelay1 :", 152, 58, 66, 17)
	Global $Label55 = GUICtrlCreateLabel("SpellEnergyNeeds1 :", 72, 88, 103, 17)
	Global $InputSpellEnergyNeeds1 = GUICtrlCreateInput("", 184, 80, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	Global $InputSpellLife1 = GUICtrlCreateInput("", 312, 80, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	Global $InputSpellDistance1 = GUICtrlCreateInput("", 472, 80, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	Global $InputSpellDelay1 = GUICtrlCreateInput("", 224, 50, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	Global $Label56 = GUICtrlCreateLabel("SpellType1 :", 296, 58, 63, 17)
	Global $inputSpellType1 = GUICtrlCreateInput("", 368, 50, 121, 21)
	Global $Label57 = GUICtrlCreateLabel("SpellLife1 :", 248, 88, 56, 17)
	Global $Label58 = GUICtrlCreateLabel("SpellDistance1 :", 384, 88, 81, 17)
	GUICtrlCreateGroup("", -99, -99, 1, 1)
	Global $GroupTouche2 = GUICtrlCreateGroup("Touche 2", 64, 123, 537, 73)
	Global $CheckboxSpellOn2 = GUICtrlCreateCheckbox("SpellOn2", 72, 141, 73, 17)
	Global $Label59 = GUICtrlCreateLabel("SpellDelay2 :", 152, 141, 66, 17)
	Global $Label60 = GUICtrlCreateLabel("SpellEnergyNeeds2 :", 72, 171, 103, 17)
	Global $InputSpellEnergyNeeds2 = GUICtrlCreateInput("", 184, 163, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	Global $InputSpellLife2 = GUICtrlCreateInput("", 312, 163, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	Global $InputSpellDistance2 = GUICtrlCreateInput("", 472, 163, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	Global $InputSpellDelay2 = GUICtrlCreateInput("", 224, 133, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	Global $Label61 = GUICtrlCreateLabel("SpellType2 :", 296, 141, 63, 17)
	Global $InputSpellType2 = GUICtrlCreateInput("", 368, 133, 121, 21)
	Global $Label62 = GUICtrlCreateLabel("SpellLife2 :", 248, 171, 56, 17)
	Global $Label63 = GUICtrlCreateLabel("SpellDistance2 :", 384, 171, 81, 17)
	GUICtrlCreateGroup("", -99, -99, 1, 1)
	Global $GroupTouche3 = GUICtrlCreateGroup("Touche 3", 64, 207, 537, 73)
	Global $CheckboxSpellOn3 = GUICtrlCreateCheckbox("SpellOn3", 72, 225, 73, 17)
	Global $Label64 = GUICtrlCreateLabel("SpellDelay3 :", 152, 225, 66, 17)
	Global $Label65 = GUICtrlCreateLabel("SpellEnergyNeeds3 :", 72, 255, 103, 17)
	Global $InputSpellEnergyNeeds3 = GUICtrlCreateInput("", 184, 247, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	Global $InputSpellLife3 = GUICtrlCreateInput("", 312, 247, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	Global $InputSpellDistance3 = GUICtrlCreateInput("", 472, 247, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	Global $InputSpellDelay3 = GUICtrlCreateInput("", 224, 217, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	Global $Label66 = GUICtrlCreateLabel("SpellType3 :", 296, 225, 63, 17)
	Global $InputSpellType3 = GUICtrlCreateInput("", 368, 217, 121, 21)
	Global $Label67 = GUICtrlCreateLabel("SpellLife3 :", 248, 255, 56, 17)
	Global $Label68 = GUICtrlCreateLabel("SpellDistance3 :", 384, 255, 81, 17)
	GUICtrlCreateGroup("", -99, -99, 1, 1)
	Global $GroupTouche4 = GUICtrlCreateGroup("Touche 4", 64, 292, 537, 73)
	Global $CheckboxSpellOn4 = GUICtrlCreateCheckbox("SpellOn4", 72, 310, 73, 17)
	Global $Label69 = GUICtrlCreateLabel("SpellDelay4 :", 152, 310, 66, 17)
	Global $Label70 = GUICtrlCreateLabel("SpellEnergyNeeds4 :", 72, 340, 103, 17)
	Global $InputSpellEnergyNeeds4 = GUICtrlCreateInput("", 184, 332, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	Global $InputSpellLife4 = GUICtrlCreateInput("", 312, 332, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	Global $InputSpellDistance4 = GUICtrlCreateInput("", 472, 332, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	Global $InputSpellDelay4 = GUICtrlCreateInput("", 224, 302, 49, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
	Global $Label71 = GUICtrlCreateLabel("SpellType4 :", 296, 310, 63, 17)
	Global $InputSpellType4 = GUICtrlCreateInput("", 368, 302, 121, 21)
	Global $Label72 = GUICtrlCreateLabel("SpellLife4 :", 248, 340, 56, 17)
	Global $Label73 = GUICtrlCreateLabel("SpellDistance4 :", 384, 340, 81, 17)
	GUICtrlCreateGroup("", -99, -99, 1, 1)
	GUICtrlCreateTabItem("")
	Global $ButtonEnregistrer = GUICtrlCreateButton("Enregistrer les modifications", 496, 392, 163, 33)
	Global $ButtonAnnuler = GUICtrlCreateButton("Annuler", 416, 392, 75, 33)
	Global $ButtonParDefaut = GUICtrlCreateButton("Par défaut", 320, 392, 91, 33)
	GUISetState(@SW_SHOW)

	GUICtrlSetState($InputProfil,$ProfilSel)
