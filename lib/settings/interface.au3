...
Func EditSettings($ProfilSel)
	...
	Global $CheckboxSecuHC = GUICtrlCreateCheckbox("Activé", 536, 152, 97, 17)
	...
	GUICtrlCreateGroup("", -99, -99, 1, 1)
	Global $Group2 = GUICtrlCreateGroup("Résurection", 528, 40, 121, 81)
	Global $CheckboxResActivated = GUICtrlCreateCheckbox("Activé", 536, 64, 97, 17)
